...
|---|---|
| A.S1 Login | `design_handoff/source/screens-manager.jsx` (LoginScreen) · `tokens.css` · `design_handoff/screenshots/01-login.png` |
| A.S2 Shell | `shell.jsx` (root, 25KB — bigger than handoff) · `design_handoff/source/shell.jsx` (compare) |
| A.S3 ManagerHome | `screens-manager.jsx` (root, 46KB) — ManagerHome variant · `dashboard-cards.jsx` (KPI variants) |
...
| A.S12 WeekCalendar | `screens-manager.jsx` — WeekCalendar function · `calendar-variations.jsx` (5 variants) · `expanded-calendar-modal.jsx` |
