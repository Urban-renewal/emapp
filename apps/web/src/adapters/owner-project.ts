 ...
 * (PROJECT_TYPE_LABELS / PROJECT_STATUS_LABELS / PROJECT_STATUS_COLORS — D.18 is
...
import { PROJECT_STATUS_COLORS, PROJECT_STATUS_LABELS, PROJECT_TYPE_LABELS } from './project';
...
export function toOwnerProjectViewModel(p: OwnerProjectSummary): OwnerProjectViewModel {
  return {
    ...
    statusColor: PROJECT_STATUS_COLORS[p.status],
  };
}
